import { ContentFragmentProps, ContentFragmentTypes } from '@/models/contentFragment'
import { DetailPostProps } from '@/models/post'
import moment from 'moment'
import React from 'react'

const PostDetail = (post: DetailPostProps) => {
  const getContentFragment = (index: number, text, obj, type?: ContentFragmentTypes) => {
  ...
  return (
    <div className='bg-white shadow-lg rounded-lg lg:p-8 pb-12 mb-8'>
      ...
      <div className='px-4 lg:px-0'>
        ...
        {post.content.raw.children.map((typeObj: ContentFragmentProps, index: number) => {
